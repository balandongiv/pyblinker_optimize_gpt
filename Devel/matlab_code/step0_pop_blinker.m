...
function [EEG, com, blinks, blinkFits, blinkProperties, blinkStatistics, ...
     ...
     data = load('C:\Users\balan\IdeaProjects\pyblinkers\Devel\step0_data_input_singleChannel_popblinker.mat');  % Loads blinkComp, blinkPositions
     % data = load('C:\Users\balan\IdeaProjects\pyblinkers\Devel\step0_data_input_allChannels_popblinker.mat');  % Loads blinkComp, blinkPositions
     EEG = data.EEG; 
     params = data.params; 
