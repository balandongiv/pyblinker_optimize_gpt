...
def get_blink_position(params, blink_component=None, ch=None):
    ...
    % Parameters:
    %    blink_component       independent component (IC) of eye-related
...
#
# def getBlinkPosition_pythonic(params, blink_component=None, ch='No_channel'):
#     """
...
#     over_mask = blink_component > threshold
#
...
#         blink_ends = np.append(blink_ends, len(blink_component) - 1)
#
